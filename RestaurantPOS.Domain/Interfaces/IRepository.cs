...
/// <typeparam name="T">Entity type deriving from <see cref="BaseEntity"/>.</typeparam>
...
/// <summary>Unit of Work pattern - coordinates repositories and transaction management.</summary>
public interface IUnitOfWork : IDisposable
{
    ...
    /// configured execution strategy so that retrying execution strategies (e.g.
    /// <c>SqlServerRetryingExecutionStrategy</c>) work correctly with user-initiated transactions.
    /// </summary>
