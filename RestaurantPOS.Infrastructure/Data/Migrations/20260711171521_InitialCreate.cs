    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HappyHours", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PointsPerSar = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SarPerPoint = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MinPointsToRedeem = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ZatcaCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ZatcaEnvironment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaCsid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaPrivateKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaPublicKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaOrganizationalUnitName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaLastCertificateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreCredit = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentTenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    HasKitchenDisplay = table.Column<bool>(type: "bit", nullable: false),
                    HasCustomerDisplay = table.Column<bool>(type: "bit", nullable: false),
                    DefaultTaxRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ServiceChargeRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsAvailableForDineIn = table.Column<bool>(type: "bit", nullable: false),
                    IsAvailableForTakeAway = table.Column<bool>(type: "bit", nullable: false),
                    IsAvailableForDelivery = table.Column<bool>(type: "bit", nullable: false),
                    IsOpenPrice = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "HappyHourProducts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HappyHourId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HappyHourProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HappyHourProducts_HappyHours_HappyHourId",
                        column: x => x.HappyHourId,
                        principalTable: "HappyHours",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HappyHourProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeIngredients_Products_IngredientProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierInvoices_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashDrawerTransactions_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiningTables_TableSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierInvoiceItems_ProductVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceChargeAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    DeliveryChargeAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TipsAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CustomerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerVat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerCr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTotal = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ...
                    ZatcaReportingRequestId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaClearanceRequestId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZatcaReportedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ZatcaRetryCount = table.Column<int>(type: "int", nullable: false),
                    IsCancelled = table.Column<bool>(type: "bit", nullable: false),
                    CancellationReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditNoteForInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DebitNoteForInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KitchenOrders_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiningTables_SectionId",
                table: "DiningTables",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HappyHourProducts_HappyHourId",
                table: "HappyHourProducts",
                column: "HappyHourId");

            migrationBuilder.CreateIndex(
                name: "IX_HappyHourProducts_ProductId",
                table: "HappyHourProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ZatcaStatus",
                table: "Invoices",
                column: "ZatcaStatus");

            migrationBuilder.CreateIndex(
                name: "IX_KitchenOrders_BranchId",
                table: "KitchenOrders",
                column: "BranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_BranchId_CreatedDate",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_WarehouseId_ProductId_MovementDate",
                table: "StockMovements",
                columns: new[] { "WarehouseId", "ProductId", "MovementDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierInvoiceItems_VariantId",
                table: "SupplierInvoiceItems",
                column: "VariantId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierInvoices_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSections_BranchId",
                table: "TableSections",
                column: "BranchId");
