...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        try
        {
            ...
            // Ensure the database compatibility level is at least 110 (SQL Server 2012)
            // so that OFFSET/FETCH NEXT pagination generated by EF Core works correctly.
            await context.Database.ExecuteSqlRawAsync(
                "IF (SELECT compatibility_level FROM sys.databases WHERE name = DB_NAME()) < 110 " +
                "EXEC(N'ALTER DATABASE [' + DB_NAME() + N'] SET COMPATIBILITY_LEVEL = 110')");
